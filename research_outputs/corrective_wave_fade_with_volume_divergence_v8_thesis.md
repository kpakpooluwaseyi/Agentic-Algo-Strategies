# Research Thesis: corrective_wave_fade_with_volume_divergence v8

## Iteration Focus: Edge Refinement

### Hypothesis
Focus only on highest probability setups, increase entry threshold
...
**Iteration 8 Goal:** Edge Refinement

**Implementation Approach:**
1. Analyze current entry/exit logic
2. Identify weakness related to edge refinement
3. Implement targeted improvement
4. Maintain simplicity - avoid over-engineering

### Expected Outcome
- Improved Sharpe ratio through edge refinement
