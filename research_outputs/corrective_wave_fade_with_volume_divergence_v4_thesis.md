# Research Thesis: corrective_wave_fade_with_volume_divergence v4

## Iteration Focus: Regime Adaptation

### Hypothesis
Adjust parameters based on market volatility regime (high/low vol)
...
**Iteration 4 Goal:** Regime Adaptation

**Implementation Approach:**
1. Analyze current entry/exit logic
2. Identify weakness related to regime adaptation
3. Implement targeted improvement
4. Maintain simplicity - avoid over-engineering

### Expected Outcome
- Improved Sharpe ratio through regime adaptation
