"""
Strategy: uk_session_asia_liquidity_reversal v8
Iteration Focus: See research_outputs/uk_session_asia_liquidity_reversal_v8_thesis.md
...
# --- Strategy Definition ---
class UkSessionAsiaLiquidityReversalV8Strategy(Strategy):
    """
