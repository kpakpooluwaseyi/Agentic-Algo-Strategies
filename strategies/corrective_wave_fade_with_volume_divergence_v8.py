"""
Strategy: corrective_wave_fade_with_volume_divergence v8
Iteration Focus: See research_outputs/corrective_wave_fade_with_volume_divergence_v8_thesis.md
...
class CorrectiveWaveFadeWithVolumeDivergenceV8Strategy(Strategy):
    # --- Strategy Parameters ---
