"""
Strategy: asia_liquidity_grab_reversal v2
Iteration Focus: See research_outputs/asia_liquidity_grab_reversal_v2_thesis.md
...
class AsiaLiquidityGrabReversalV2Strategy(Strategy):
