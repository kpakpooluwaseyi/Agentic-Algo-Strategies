"""
Strategy: asia_liquidity_grab_reversal v1
Iteration Focus: See research_outputs/asia_liquidity_grab_reversal_v1_thesis.md
...
class AsiaLiquidityGrabReversalV1Strategy(Strategy):
