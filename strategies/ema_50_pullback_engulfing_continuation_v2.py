"""
Strategy: ema_50_pullback_engulfing_continuation v2
Iteration Focus: See research_outputs/ema_50_pullback_engulfing_continuation_v2_thesis.md
...
class Ema50PullbackEngulfingContinuationV2Strategy(Strategy):
    """
