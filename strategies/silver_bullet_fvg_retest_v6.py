"""
Strategy: silver_bullet_fvg_retest v6
Iteration Focus: See research_outputs/silver_bullet_fvg_retest_v6_thesis.md
...
class SilverBulletFvgRetestV6Strategy(Strategy):
    # Parameters
    stop_loss_pct = 0.5
    swing_distance = 10
