"""
Strategy: asia_session_liquidity_grab_reversal v3
Iteration Focus: See research_outputs/asia_session_liquidity_grab_reversal_v3_thesis.md
...
class AsiaSessionLiquidityGrabReversalV3Strategy(Strategy):
