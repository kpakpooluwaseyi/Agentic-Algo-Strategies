"""
Strategy: asia_liquidity_sweep_reversal v4
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_v4_thesis.md
...
class AsiaLiquiditySweepReversalV4Strategy(Strategy):
    asr_max_percent = 2.0
