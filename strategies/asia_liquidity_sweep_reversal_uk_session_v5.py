"""
Strategy: asia_liquidity_sweep_reversal_uk_session v5
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_uk_session_v5_thesis.md
...
class AsiaLiquiditySweepReversalUkSessionV5Strategy(Strategy):
    asia_range_max = 2.0
