"""
Strategy: asia_liquidity_grab_reversal_uk_session v8
Iteration Focus: See research_outputs/asia_liquidity_grab_reversal_uk_session_v8_thesis.md
...
class AsiaLiquidityGrabReversalUkSessionV8Strategy(Strategy):
