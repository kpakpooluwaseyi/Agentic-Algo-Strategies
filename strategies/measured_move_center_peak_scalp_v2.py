"""
Strategy: measured_move_center_peak_scalp v2
Iteration Focus: See research_outputs/measured_move_center_peak_scalp_v2_thesis.md
...
class MeasuredMoveCenterPeakScalpV2Strategy(Strategy):
