"""
Strategy: ema_50_pullback_engulfing_continuation v7
Iteration Focus: See research_outputs/ema_50_pullback_engulfing_continuation_v7_thesis.md
...
class Ema50PullbackEngulfingContinuationV7Strategy(Strategy):
    """
