"""
Strategy: asia_liquidity_sweep_reversal v1
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_v1_thesis.md
...
class AsiaLiquiditySweepReversalV1Strategy(Strategy):
    asr_max_percent = 2.0
