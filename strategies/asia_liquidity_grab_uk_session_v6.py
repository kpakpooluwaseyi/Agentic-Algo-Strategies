"""
Strategy: asia_liquidity_grab_uk_session v6
Iteration Focus: See research_outputs/asia_liquidity_grab_uk_session_v6_thesis.md
...
class AsiaLiquidityGrabUkSessionV6Strategy(Strategy):
    """
