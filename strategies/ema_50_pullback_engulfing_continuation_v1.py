"""
Strategy: ema_50_pullback_engulfing_continuation v1
Iteration Focus: See research_outputs/ema_50_pullback_engulfing_continuation_v1_thesis.md
...
class Ema50PullbackEngulfingContinuationV1Strategy(Strategy):
    """
