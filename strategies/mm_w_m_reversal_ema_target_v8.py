"""
Strategy: mm_w_m_reversal_ema_target v8
Iteration Focus: See research_outputs/mm_w_m_reversal_ema_target_v8_thesis.md
...
class MmWMReversalEmaTargetV8Strategy(Strategy):
