"""
Strategy: ema_50_pullback_engulfing_continuation v5
Iteration Focus: See research_outputs/ema_50_pullback_engulfing_continuation_v5_thesis.md
...
class Ema50PullbackEngulfingContinuationV5Strategy(Strategy):
    """
