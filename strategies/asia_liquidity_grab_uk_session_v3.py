"""
Strategy: asia_liquidity_grab_uk_session v3
Iteration Focus: See research_outputs/asia_liquidity_grab_uk_session_v3_thesis.md
...
class AsiaLiquidityGrabUkSessionV3Strategy(Strategy):
    """
