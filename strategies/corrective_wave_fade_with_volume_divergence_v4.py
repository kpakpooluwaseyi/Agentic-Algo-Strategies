"""
Strategy: corrective_wave_fade_with_volume_divergence v4
Iteration Focus: See research_outputs/corrective_wave_fade_with_volume_divergence_v4_thesis.md
...
class CorrectiveWaveFadeWithVolumeDivergenceV4Strategy(Strategy):
    # --- Strategy Parameters ---
