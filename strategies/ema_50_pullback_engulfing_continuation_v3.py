"""
Strategy: ema_50_pullback_engulfing_continuation v3
Iteration Focus: See research_outputs/ema_50_pullback_engulfing_continuation_v3_thesis.md
...
class Ema50PullbackEngulfingContinuationV3Strategy(Strategy):
    """
