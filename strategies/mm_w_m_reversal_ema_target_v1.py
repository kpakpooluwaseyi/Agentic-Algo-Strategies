"""
Strategy: mm_w_m_reversal_ema_target v1
Iteration Focus: See research_outputs/mm_w_m_reversal_ema_target_v1_thesis.md
...
class MmWMReversalEmaTargetV1Strategy(Strategy):
