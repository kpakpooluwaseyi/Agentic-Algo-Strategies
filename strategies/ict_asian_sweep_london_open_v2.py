"""
Strategy: ict_asian_sweep_london_open v2
Iteration Focus: See research_outputs/ict_asian_sweep_london_open_v2_thesis.md
...
class IctAsianSweepLondonOpenV2Strategy(Strategy):
