"""
Strategy: bitcoin_monthly_moon_pivot v2
Iteration Focus: See research_outputs/bitcoin_monthly_moon_pivot_v2_thesis.md
...
class BitcoinMonthlyMoonPivotV2Strategy(Strategy):
