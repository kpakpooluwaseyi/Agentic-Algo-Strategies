"""
Strategy: asia_liquidity_sweep_reversal_uk_session v6
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_uk_session_v6_thesis.md
...
class AsiaLiquiditySweepReversalUkSessionV6Strategy(Strategy):
    asia_range_max = 2.0
