"""
Strategy: mm_w_m_reversal_ema_target v2
Iteration Focus: See research_outputs/mm_w_m_reversal_ema_target_v2_thesis.md
...
class MmWMReversalEmaTargetV2Strategy(Strategy):
