"""
Strategy: corrective_wave_fade_with_volume_divergence v6
Iteration Focus: See research_outputs/corrective_wave_fade_with_volume_divergence_v6_thesis.md
...
class CorrectiveWaveFadeWithVolumeDivergenceV6Strategy(Strategy):
    # --- Strategy Parameters ---
