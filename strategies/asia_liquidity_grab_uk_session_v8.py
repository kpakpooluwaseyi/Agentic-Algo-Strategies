"""
Strategy: asia_liquidity_grab_uk_session v8
Iteration Focus: See research_outputs/asia_liquidity_grab_uk_session_v8_thesis.md
...
class AsiaLiquidityGrabUkSessionV8Strategy(Strategy):
    """
