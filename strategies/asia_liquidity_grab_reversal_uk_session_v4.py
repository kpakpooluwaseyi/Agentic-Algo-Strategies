"""
Strategy: asia_liquidity_grab_reversal_uk_session v4
Iteration Focus: See research_outputs/asia_liquidity_grab_reversal_uk_session_v4_thesis.md
...
class AsiaLiquidityGrabReversalUkSessionV4Strategy(Strategy):
