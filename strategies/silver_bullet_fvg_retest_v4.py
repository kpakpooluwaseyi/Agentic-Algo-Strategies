"""
Strategy: silver_bullet_fvg_retest v4
Iteration Focus: See research_outputs/silver_bullet_fvg_retest_v4_thesis.md
...
class SilverBulletFvgRetestV4Strategy(Strategy):
    # Parameters
    stop_loss_pct = 0.5
    swing_distance = 10
