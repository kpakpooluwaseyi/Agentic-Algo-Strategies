"""
Strategy: asia_liquidity_sweep_reversal_uk_session v4
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_uk_session_v4_thesis.md
...
class AsiaLiquiditySweepReversalUkSessionV4Strategy(Strategy):
    asia_range_max = 2.0
