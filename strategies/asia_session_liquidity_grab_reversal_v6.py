"""
Strategy: asia_session_liquidity_grab_reversal v6
Iteration Focus: See research_outputs/asia_session_liquidity_grab_reversal_v6_thesis.md
...
class AsiaSessionLiquidityGrabReversalV6Strategy(Strategy):
