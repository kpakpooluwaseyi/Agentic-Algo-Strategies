"""
Strategy: ict_asian_sweep_london_open v3
Iteration Focus: See research_outputs/ict_asian_sweep_london_open_v3_thesis.md
...
class IctAsianSweepLondonOpenV3Strategy(Strategy):
