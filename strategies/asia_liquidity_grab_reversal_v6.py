"""
Strategy: asia_liquidity_grab_reversal v6
Iteration Focus: See research_outputs/asia_liquidity_grab_reversal_v6_thesis.md
...
class AsiaLiquidityGrabReversalV6Strategy(Strategy):
