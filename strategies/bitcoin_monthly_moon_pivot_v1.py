"""
Strategy: bitcoin_monthly_moon_pivot v1
Iteration Focus: See research_outputs/bitcoin_monthly_moon_pivot_v1_thesis.md
...
class BitcoinMonthlyMoonPivotV1Strategy(Strategy):
