"""
Strategy: asia_liquidity_sweep_reversal_uk_session v1
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_uk_session_v1_thesis.md
...
class AsiaLiquiditySweepReversalUkSessionV1Strategy(Strategy):
    asia_range_max = 2.0
