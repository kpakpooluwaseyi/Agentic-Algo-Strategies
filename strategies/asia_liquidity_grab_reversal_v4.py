"""
Strategy: asia_liquidity_grab_reversal v4
Iteration Focus: See research_outputs/asia_liquidity_grab_reversal_v4_thesis.md
...
class AsiaLiquidityGrabReversalV4Strategy(Strategy):
