"""
Strategy: asia_liquidity_grab_reversal_uk_session v3
Iteration Focus: See research_outputs/asia_liquidity_grab_reversal_uk_session_v3_thesis.md
...
class AsiaLiquidityGrabReversalUkSessionV3Strategy(Strategy):
