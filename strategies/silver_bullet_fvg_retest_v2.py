"""
Strategy: silver_bullet_fvg_retest v2
Iteration Focus: See research_outputs/silver_bullet_fvg_retest_v2_thesis.md
...
class SilverBulletFvgRetestV2Strategy(Strategy):
    # Parameters
    stop_loss_pct = 0.5
    swing_distance = 10
