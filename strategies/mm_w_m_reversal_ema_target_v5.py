"""
Strategy: mm_w_m_reversal_ema_target v5
Iteration Focus: See research_outputs/mm_w_m_reversal_ema_target_v5_thesis.md
...
class MmWMReversalEmaTargetV5Strategy(Strategy):
