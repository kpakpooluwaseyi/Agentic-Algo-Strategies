"""
Strategy: mm_w_m_reversal_ema_target v7
Iteration Focus: See research_outputs/mm_w_m_reversal_ema_target_v7_thesis.md
...
class MmWMReversalEmaTargetV7Strategy(Strategy):
