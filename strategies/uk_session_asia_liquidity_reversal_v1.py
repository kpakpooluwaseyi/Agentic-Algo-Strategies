"""
Strategy: uk_session_asia_liquidity_reversal v1
Iteration Focus: See research_outputs/uk_session_asia_liquidity_reversal_v1_thesis.md
...
# --- Strategy Definition ---
class UkSessionAsiaLiquidityReversalV1Strategy(Strategy):
    """
