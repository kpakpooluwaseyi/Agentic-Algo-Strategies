"""
Strategy: bitcoin_monthly_moon_pivot v7
Iteration Focus: See research_outputs/bitcoin_monthly_moon_pivot_v7_thesis.md
...
class BitcoinMonthlyMoonPivotV7Strategy(Strategy):
