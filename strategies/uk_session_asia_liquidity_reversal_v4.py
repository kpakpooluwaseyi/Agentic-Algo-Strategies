"""
Strategy: uk_session_asia_liquidity_reversal v4
Iteration Focus: See research_outputs/uk_session_asia_liquidity_reversal_v4_thesis.md
...
# --- Strategy Definition ---
class UkSessionAsiaLiquidityReversalV4Strategy(Strategy):
    """
