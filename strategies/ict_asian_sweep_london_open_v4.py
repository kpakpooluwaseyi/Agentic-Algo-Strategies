"""
Strategy: ict_asian_sweep_london_open v4
Iteration Focus: See research_outputs/ict_asian_sweep_london_open_v4_thesis.md
...
class IctAsianSweepLondonOpenV4Strategy(Strategy):
