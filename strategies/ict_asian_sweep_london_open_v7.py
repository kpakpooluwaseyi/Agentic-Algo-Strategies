"""
Strategy: ict_asian_sweep_london_open v7
Iteration Focus: See research_outputs/ict_asian_sweep_london_open_v7_thesis.md
...
class IctAsianSweepLondonOpenV7Strategy(Strategy):
