"""
Strategy: m15_ema_structure_retest v5
Iteration Focus: See research_outputs/m15_ema_structure_retest_v5_thesis.md
...
class M15EmaStructureRetestV5Strategy(Strategy):
    ema_fast_period = 50
    ema_slow_period = 200
    swing_distance = 15
