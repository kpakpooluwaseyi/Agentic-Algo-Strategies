"""
Strategy: asia_liquidity_grab_uk_session v7
Iteration Focus: See research_outputs/asia_liquidity_grab_uk_session_v7_thesis.md
...
class AsiaLiquidityGrabUkSessionV7Strategy(Strategy):
    """
