"""
Strategy: measured_move_center_peak_scalp v1
Iteration Focus: See research_outputs/measured_move_center_peak_scalp_v1_thesis.md
...
class MeasuredMoveCenterPeakScalpV1Strategy(Strategy):
