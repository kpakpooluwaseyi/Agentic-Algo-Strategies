"""
Strategy: measured_move_center_peak_scalp v3
Iteration Focus: See research_outputs/measured_move_center_peak_scalp_v3_thesis.md
...
class MeasuredMoveCenterPeakScalpV3Strategy(Strategy):
