"""
Strategy: bitcoin_monthly_moon_pivot v3
Iteration Focus: See research_outputs/bitcoin_monthly_moon_pivot_v3_thesis.md
...
class BitcoinMonthlyMoonPivotV3Strategy(Strategy):
