"""
Strategy: ema_50_pullback_engulfing_continuation v6
Iteration Focus: See research_outputs/ema_50_pullback_engulfing_continuation_v6_thesis.md
...
class Ema50PullbackEngulfingContinuationV6Strategy(Strategy):
    """
