"""
Strategy: ema_50_pullback_engulfing_continuation v8
Iteration Focus: See research_outputs/ema_50_pullback_engulfing_continuation_v8_thesis.md
...
class Ema50PullbackEngulfingContinuationV8Strategy(Strategy):
    """
