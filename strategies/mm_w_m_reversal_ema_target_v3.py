"""
Strategy: mm_w_m_reversal_ema_target v3
Iteration Focus: See research_outputs/mm_w_m_reversal_ema_target_v3_thesis.md
...
class MmWMReversalEmaTargetV3Strategy(Strategy):
