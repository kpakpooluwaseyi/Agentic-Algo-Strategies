"""
Strategy: uk_session_asia_liquidity_reversal v3
Iteration Focus: See research_outputs/uk_session_asia_liquidity_reversal_v3_thesis.md
...
# --- Strategy Definition ---
class UkSessionAsiaLiquidityReversalV3Strategy(Strategy):
    """
