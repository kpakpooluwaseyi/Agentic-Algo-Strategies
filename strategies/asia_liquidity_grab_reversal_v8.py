"""
Strategy: asia_liquidity_grab_reversal v8
Iteration Focus: See research_outputs/asia_liquidity_grab_reversal_v8_thesis.md
...
class AsiaLiquidityGrabReversalV8Strategy(Strategy):
