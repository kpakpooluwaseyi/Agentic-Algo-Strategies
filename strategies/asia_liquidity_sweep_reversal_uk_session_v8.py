"""
Strategy: asia_liquidity_sweep_reversal_uk_session v8
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_uk_session_v8_thesis.md
...
class AsiaLiquiditySweepReversalUkSessionV8Strategy(Strategy):
    asia_range_max = 2.0
