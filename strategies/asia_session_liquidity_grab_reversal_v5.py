"""
Strategy: asia_session_liquidity_grab_reversal v5
Iteration Focus: See research_outputs/asia_session_liquidity_grab_reversal_v5_thesis.md
...
class AsiaSessionLiquidityGrabReversalV5Strategy(Strategy):
