"""
Strategy: uk_session_asia_liquidity_reversal v5
Iteration Focus: See research_outputs/uk_session_asia_liquidity_reversal_v5_thesis.md
...
# --- Strategy Definition ---
class UkSessionAsiaLiquidityReversalV5Strategy(Strategy):
    """
