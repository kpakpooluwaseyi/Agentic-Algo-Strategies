"""
Strategy: asia_liquidity_sweep_reversal v6
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_v6_thesis.md
...
class AsiaLiquiditySweepReversalV6Strategy(Strategy):
    asr_max_percent = 2.0
