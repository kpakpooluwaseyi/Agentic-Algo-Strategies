"""
Strategy: measured_move_center_peak_scalp v5
Iteration Focus: See research_outputs/measured_move_center_peak_scalp_v5_thesis.md
...
class MeasuredMoveCenterPeakScalpV5Strategy(Strategy):
