"""
Strategy: silver_bullet_fvg_retest v3
Iteration Focus: See research_outputs/silver_bullet_fvg_retest_v3_thesis.md
...
class SilverBulletFvgRetestV3Strategy(Strategy):
    # Parameters
    stop_loss_pct = 0.5
    swing_distance = 10
