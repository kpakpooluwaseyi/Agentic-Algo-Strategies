"""
Strategy: bitcoin_monthly_moon_pivot v6
Iteration Focus: See research_outputs/bitcoin_monthly_moon_pivot_v6_thesis.md
...
class BitcoinMonthlyMoonPivotV6Strategy(Strategy):
