"""
Strategy: ema_structure_retest_15m v4
Iteration Focus: See research_outputs/ema_structure_retest_15m_v4_thesis.md
...
class EmaStructureRetest15MV4Strategy(Strategy):
    # --- Strategy Parameters ---
    ema_fast_period = 50
    ema_slow_period = 200
