"""
Strategy: silver_bullet_fvg_retest v7
Iteration Focus: See research_outputs/silver_bullet_fvg_retest_v7_thesis.md
...
class SilverBulletFvgRetestV7Strategy(Strategy):
    # Parameters
    stop_loss_pct = 0.5
    swing_distance = 10
