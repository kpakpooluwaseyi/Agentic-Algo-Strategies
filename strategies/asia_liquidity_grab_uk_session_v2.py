"""
Strategy: asia_liquidity_grab_uk_session v2
Iteration Focus: See research_outputs/asia_liquidity_grab_uk_session_v2_thesis.md
...
class AsiaLiquidityGrabUkSessionV2Strategy(Strategy):
    """
