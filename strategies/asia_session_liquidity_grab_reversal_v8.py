"""
Strategy: asia_session_liquidity_grab_reversal v8
Iteration Focus: See research_outputs/asia_session_liquidity_grab_reversal_v8_thesis.md
...
class AsiaSessionLiquidityGrabReversalV8Strategy(Strategy):
