"""
Strategy: asia_liquidity_sweep_reversal v7
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_v7_thesis.md
...
class AsiaLiquiditySweepReversalV7Strategy(Strategy):
    asr_max_percent = 2.0
