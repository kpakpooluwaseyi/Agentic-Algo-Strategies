"""
Strategy: asia_liquidity_sweep_reversal_uk_session v7
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_uk_session_v7_thesis.md
...
class AsiaLiquiditySweepReversalUkSessionV7Strategy(Strategy):
    asia_range_max = 2.0
