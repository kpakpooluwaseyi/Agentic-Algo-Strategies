"""
Strategy: ema_structure_retest_15m v7
Iteration Focus: See research_outputs/ema_structure_retest_15m_v7_thesis.md
...
class EmaStructureRetest15MV7Strategy(Strategy):
    # --- Strategy Parameters ---
    ema_fast_period = 50
    ema_slow_period = 200
