"""
Strategy: ict_asian_sweep_london_open v6
Iteration Focus: See research_outputs/ict_asian_sweep_london_open_v6_thesis.md
...
class IctAsianSweepLondonOpenV6Strategy(Strategy):
