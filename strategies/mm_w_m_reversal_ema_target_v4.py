"""
Strategy: mm_w_m_reversal_ema_target v4
Iteration Focus: See research_outputs/mm_w_m_reversal_ema_target_v4_thesis.md
...
class MmWMReversalEmaTargetV4Strategy(Strategy):
