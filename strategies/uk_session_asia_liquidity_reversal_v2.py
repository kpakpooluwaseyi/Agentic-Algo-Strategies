"""
Strategy: uk_session_asia_liquidity_reversal v2
Iteration Focus: See research_outputs/uk_session_asia_liquidity_reversal_v2_thesis.md
...
# --- Strategy Definition ---
class UkSessionAsiaLiquidityReversalV2Strategy(Strategy):
    """
