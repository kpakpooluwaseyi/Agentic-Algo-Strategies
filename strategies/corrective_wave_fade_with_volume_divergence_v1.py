"""
Strategy: corrective_wave_fade_with_volume_divergence v1
Iteration Focus: See research_outputs/corrective_wave_fade_with_volume_divergence_v1_thesis.md
...
class CorrectiveWaveFadeWithVolumeDivergenceV1Strategy(Strategy):
    # --- Strategy Parameters ---
