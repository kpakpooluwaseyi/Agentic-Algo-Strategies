"""
Strategy: bitcoin_monthly_moon_pivot v4
Iteration Focus: See research_outputs/bitcoin_monthly_moon_pivot_v4_thesis.md
...
class BitcoinMonthlyMoonPivotV4Strategy(Strategy):
