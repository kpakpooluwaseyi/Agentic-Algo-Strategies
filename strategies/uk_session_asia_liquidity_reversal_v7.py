"""
Strategy: uk_session_asia_liquidity_reversal v7
Iteration Focus: See research_outputs/uk_session_asia_liquidity_reversal_v7_thesis.md
...
# --- Strategy Definition ---
class UkSessionAsiaLiquidityReversalV7Strategy(Strategy):
    """
