"""
Strategy: measured_move_center_peak_scalp v4
Iteration Focus: See research_outputs/measured_move_center_peak_scalp_v4_thesis.md
...
class MeasuredMoveCenterPeakScalpV4Strategy(Strategy):
