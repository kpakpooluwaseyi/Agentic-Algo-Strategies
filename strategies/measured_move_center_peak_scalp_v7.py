"""
Strategy: measured_move_center_peak_scalp v7
Iteration Focus: See research_outputs/measured_move_center_peak_scalp_v7_thesis.md
...
class MeasuredMoveCenterPeakScalpV7Strategy(Strategy):
