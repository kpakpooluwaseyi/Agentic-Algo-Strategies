"""
Strategy: asia_liquidity_sweep_reversal v2
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_v2_thesis.md
...
class AsiaLiquiditySweepReversalV2Strategy(Strategy):
    asr_max_percent = 2.0
