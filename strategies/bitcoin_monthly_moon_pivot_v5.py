"""
Strategy: bitcoin_monthly_moon_pivot v5
Iteration Focus: See research_outputs/bitcoin_monthly_moon_pivot_v5_thesis.md
...
class BitcoinMonthlyMoonPivotV5Strategy(Strategy):
