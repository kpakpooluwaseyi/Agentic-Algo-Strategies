"""
Strategy: asia_session_liquidity_grab_reversal v2
Iteration Focus: See research_outputs/asia_session_liquidity_grab_reversal_v2_thesis.md
...
class AsiaSessionLiquidityGrabReversalV2Strategy(Strategy):
