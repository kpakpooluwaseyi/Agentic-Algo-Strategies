"""
Strategy: mm_w_m_reversal_ema_target v6
Iteration Focus: See research_outputs/mm_w_m_reversal_ema_target_v6_thesis.md
...
class MmWMReversalEmaTargetV6Strategy(Strategy):
