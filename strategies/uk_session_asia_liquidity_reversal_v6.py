"""
Strategy: uk_session_asia_liquidity_reversal v6
Iteration Focus: See research_outputs/uk_session_asia_liquidity_reversal_v6_thesis.md
...
# --- Strategy Definition ---
class UkSessionAsiaLiquidityReversalV6Strategy(Strategy):
    """
