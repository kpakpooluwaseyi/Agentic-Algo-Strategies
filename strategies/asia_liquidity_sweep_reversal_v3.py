"""
Strategy: asia_liquidity_sweep_reversal v3
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_v3_thesis.md
...
class AsiaLiquiditySweepReversalV3Strategy(Strategy):
    asr_max_percent = 2.0
