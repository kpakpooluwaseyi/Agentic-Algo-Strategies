"""
Strategy: asia_session_liquidity_grab_reversal v1
Iteration Focus: See research_outputs/asia_session_liquidity_grab_reversal_v1_thesis.md
...
class AsiaSessionLiquidityGrabReversalV1Strategy(Strategy):
