"""
Strategy: asia_liquidity_sweep_reversal_uk_session v3
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_uk_session_v3_thesis.md
...
class AsiaLiquiditySweepReversalUkSessionV3Strategy(Strategy):
    asia_range_max = 2.0
