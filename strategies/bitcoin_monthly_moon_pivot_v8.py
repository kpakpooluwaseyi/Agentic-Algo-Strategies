"""
Strategy: bitcoin_monthly_moon_pivot v8
Iteration Focus: See research_outputs/bitcoin_monthly_moon_pivot_v8_thesis.md
...
class BitcoinMonthlyMoonPivotV8Strategy(Strategy):
