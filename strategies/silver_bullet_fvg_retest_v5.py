"""
Strategy: silver_bullet_fvg_retest v5
Iteration Focus: See research_outputs/silver_bullet_fvg_retest_v5_thesis.md
...
class SilverBulletFvgRetestV5Strategy(Strategy):
    # Parameters
    stop_loss_pct = 0.5
    swing_distance = 10
