"""
Strategy: asia_liquidity_sweep_reversal v5
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_v5_thesis.md
...
class AsiaLiquiditySweepReversalV5Strategy(Strategy):
    asr_max_percent = 2.0
