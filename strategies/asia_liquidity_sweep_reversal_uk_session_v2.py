"""
Strategy: asia_liquidity_sweep_reversal_uk_session v2
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_uk_session_v2_thesis.md
...
class AsiaLiquiditySweepReversalUkSessionV2Strategy(Strategy):
    asia_range_max = 2.0
