"""
Strategy: asia_liquidity_grab_reversal v5
Iteration Focus: See research_outputs/asia_liquidity_grab_reversal_v5_thesis.md
...
class AsiaLiquidityGrabReversalV5Strategy(Strategy):
