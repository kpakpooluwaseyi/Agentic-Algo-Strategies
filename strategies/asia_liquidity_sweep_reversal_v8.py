"""
Strategy: asia_liquidity_sweep_reversal v8
Iteration Focus: See research_outputs/asia_liquidity_sweep_reversal_v8_thesis.md
...
class AsiaLiquiditySweepReversalV8Strategy(Strategy):
    asr_max_percent = 2.0
