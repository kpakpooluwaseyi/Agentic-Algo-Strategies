"""
Strategy: asia_session_liquidity_grab_reversal v7
Iteration Focus: See research_outputs/asia_session_liquidity_grab_reversal_v7_thesis.md
...
class AsiaSessionLiquidityGrabReversalV7Strategy(Strategy):
