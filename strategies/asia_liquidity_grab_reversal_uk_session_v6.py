"""
Strategy: asia_liquidity_grab_reversal_uk_session v6
Iteration Focus: See research_outputs/asia_liquidity_grab_reversal_uk_session_v6_thesis.md
...
class AsiaLiquidityGrabReversalUkSessionV6Strategy(Strategy):
