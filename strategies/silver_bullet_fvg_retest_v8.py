"""
Strategy: silver_bullet_fvg_retest v8
Iteration Focus: See research_outputs/silver_bullet_fvg_retest_v8_thesis.md
...
class SilverBulletFvgRetestV8Strategy(Strategy):
    # Parameters
    stop_loss_pct = 0.5
    swing_distance = 10
