"""
Strategy: asia_liquidity_grab_reversal_uk_session v5
Iteration Focus: See research_outputs/asia_liquidity_grab_reversal_uk_session_v5_thesis.md
...
class AsiaLiquidityGrabReversalUkSessionV5Strategy(Strategy):
