"""
Strategy: ict_asian_sweep_london_open v1
Iteration Focus: See research_outputs/ict_asian_sweep_london_open_v1_thesis.md
...
class IctAsianSweepLondonOpenV1Strategy(Strategy):
