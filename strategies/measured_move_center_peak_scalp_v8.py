"""
Strategy: measured_move_center_peak_scalp v8
Iteration Focus: See research_outputs/measured_move_center_peak_scalp_v8_thesis.md
...
class MeasuredMoveCenterPeakScalpV8Strategy(Strategy):
