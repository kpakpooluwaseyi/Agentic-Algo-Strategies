"""
Strategy: ict_asian_sweep_london_open v8
Iteration Focus: See research_outputs/ict_asian_sweep_london_open_v8_thesis.md
...
class IctAsianSweepLondonOpenV8Strategy(Strategy):
