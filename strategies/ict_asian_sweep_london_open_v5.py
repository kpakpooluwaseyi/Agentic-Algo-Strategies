"""
Strategy: ict_asian_sweep_london_open v5
Iteration Focus: See research_outputs/ict_asian_sweep_london_open_v5_thesis.md
...
class IctAsianSweepLondonOpenV5Strategy(Strategy):
