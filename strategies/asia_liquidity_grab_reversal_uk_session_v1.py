"""
Strategy: asia_liquidity_grab_reversal_uk_session v1
Iteration Focus: See research_outputs/asia_liquidity_grab_reversal_uk_session_v1_thesis.md
...
class AsiaLiquidityGrabReversalUkSessionV1Strategy(Strategy):
