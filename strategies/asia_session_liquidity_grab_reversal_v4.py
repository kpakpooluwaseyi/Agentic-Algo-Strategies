"""
Strategy: asia_session_liquidity_grab_reversal v4
Iteration Focus: See research_outputs/asia_session_liquidity_grab_reversal_v4_thesis.md
...
class AsiaSessionLiquidityGrabReversalV4Strategy(Strategy):
