"""
Strategy: measured_50_percent_retracement_scalp v4
Iteration Focus: See research_outputs/measured_50_percent_retracement_scalp_v4_thesis.md
...
class Measured50PercentRetracementScalpV4Strategy(Strategy):
    rr_ratio = 5
    aoi_proximity = 0.01
    ema_period = 200
