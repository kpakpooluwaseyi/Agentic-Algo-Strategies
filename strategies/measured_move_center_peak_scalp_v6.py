"""
Strategy: measured_move_center_peak_scalp v6
Iteration Focus: See research_outputs/measured_move_center_peak_scalp_v6_thesis.md
...
class MeasuredMoveCenterPeakScalpV6Strategy(Strategy):
