"""
Strategy: silver_bullet_fvg_retest v1
Iteration Focus: See research_outputs/silver_bullet_fvg_retest_v1_thesis.md
...
class SilverBulletFvgRetestV1Strategy(Strategy):
    # Parameters
    stop_loss_pct = 0.5
    swing_distance = 10
